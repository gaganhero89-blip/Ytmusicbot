...
class Config:
    ...
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL: str = getenv(
            "SUPPORT_CHANNEL", "https://t.me/AdamMusicbotupdates")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/AdamBot_support")
        ...
        self.START_IMG: str = getenv(
            "START_IMG", "https://i.ibb.co/KpxDN1yh/x.jpg")  # Start command image
        self.RADIO_IMG: str = getenv(
            "RADIO_IMG", "https://i.ibb.co/PG18B8mm/x.jpg")    # Radio command image
